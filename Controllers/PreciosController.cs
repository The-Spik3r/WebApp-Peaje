...
namespace Peajes.Controllers
{
    public class PreciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,precio,TipoVehiculo")] Precio precio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,precio,TipoVehiculo")] Precio precio)
        {
            if (id != precio.id)
            {
                return NotFound();
